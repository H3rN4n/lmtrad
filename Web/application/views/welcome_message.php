...
<!-- FONT ICONS -->
<!-- IonIcons -->
<link rel="stylesheet" href="/assets/assets/ionicons/css/ionicons.css">
...
<!-- Elegant Icons -->
<link rel="stylesheet" href="/assets/assets/elegant-icons/style.css">
		...
		<div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img src="/assets/images/logo-dark.png" alt=""></a>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 intro-section">
				...
				<a href="#section8" class="btn standard-button">Get Started</a>
				<a href="#section1" class="btn secondary-button-white">Learn More</a>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="side-screenshot pull-left">
				<img src="/assets/images/image-1.jpg" alt="Feature" class="img-responsive">
			</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="side-screenshot2 pull-right">
				<img src="/assets/images/image-2.jpg" alt="Feature" class="img-responsive">
			</div>
		</div>
			...
			<div class="col-md-4">
				<div class="package bgcolor-white">
					<div class="header dark-bg">
						<h3>Basic</h3>
						<div class="sub-heading">
							From <span class="colored-text strong">$39</span> per month
						</div>
					</div>
			...
			<div class="col-md-4">
				<div class="package bgcolor-white">
					<div class="header color-bg">
						<h3>Premium</h3>
						<div class="sub-heading">
							From <span class=" strong">$59</span> per month
						</div>
					</div>
			...
			<div class="col-md-4">
				<div class="package bgcolor-white">
					<div class="header dark-bg">
						<h3>Ultimate</h3>
						<div class="sub-heading">
							From <span class="colored-text strong">$99</span> per month
						</div>
					</div>
...
<div class="container">
	...
	<div class="row screenshots">
		...
		<div id="screenshots" class="owl-carousel owl-theme">
			...
			<div class="shot">
				<a href="/assets/images/screenshots/1.jpg" data-lightbox-gallery="screenshots-gallery"><img src="/assets/images/screenshots/1.jpg" alt="Screenshot"></a>
			</div>

			<div class="shot">
				<a href="/assets/images/screenshots/3.jpg" data-lightbox-gallery="screenshots-gallery"><img src="/assets/images/screenshots/3.jpg" alt="Screenshot"></a>
			</div>

			<div class="shot">
				<a href="/assets/images/screenshots/2.jpg" data-lightbox-gallery="screenshots-gallery"><img src="/assets/images/screenshots/2.jpg" alt="Screenshot"></a>
			</div>

			<div class="shot">
				<a href="/assets/images/screenshots/4.jpg" data-lightbox-gallery="screenshots-gallery"><img src="/assets/images/screenshots/4.jpg" alt="Screenshot"></a>
			</div>
	...
	<div class="row clients">
		<div class="col-md-12 col-sm-12">
			<ul class="client-logos">
				<li><a href=""><img src="/assets/images/clients/1.png" alt=""></a></li>
				<li><a href=""><img src="/assets/images/clients/2.png" alt=""></a></li>
				<li><a href=""><img src="/assets/images/clients/3.png" alt=""></a></li>
				<li><a href=""><img src="/assets/images/clients/4.png" alt=""></a></li>
			</ul>
		</div>
	</div>
		...
		<div id="feedbacks" class="owl-carousel owl-theme">
			...
			<div class="single-feedback">
				<div class="client-pic">
					<img src="/assets/images/client-pics/1.jpg" alt="">
				</div>
				<div class="box">
					<p class="message">
			...
			<div class="single-feedback">
				<div class="client-pic">
					<img src="/assets/images/client-pics/2.jpg" alt="">
				</div>
				<div class="box">
					<p class="message">
						 Lorem lean startup ipsum product market fit customer development acquihire technical cofounder. User engagement A/B testing shrink a market venture capital pitch deck. Social bookmarking group buying crowded market pivot onboarding.
			...
			<div class="single-feedback">
				<div class="client-pic">
					<img src="/assets/images/client-pics/3.jpg" alt="">
				</div>
				<div class="box">
					<p class="message">
						 Lorem lean startup ipsum product market fit customer development acquihire technical cofounder. User engagement A/B testing shrink a market venture capital pitch deck. Social bookmarking group buying crowded market pivot onboarding.
...
<div class="demo-style-switch" id="switch-style">
	...
	<div class="switched-options">
		...
		<ul>
			...
			<li><a href="../layout-style-two/index.html">Layout Style Two</a></li>
			<li class="active">Layout Style Three <span class="olored-text icon_check"></span></li>
